            ...
            (j.prototype = {
                ...
                finish: function (t) {
                    for (var e = this.tryEntries.length - 1; e >= 0; --e) {
                        ...
                        if (n.finallyLoc === t)
                            return (
                                this.complete(n.completion, n.afterLoc), S(n), h
                            );
                    }
                },
                catch: function (t) {
            ...
            function (t) {
                var e =
                    arguments.length > 1 && void 0 !== arguments[1]
                        ...
                        : "introjs-stamp";
                return (
                    (b[e] = b[e] || 0), void 0 === t[e] && (t[e] = b[e]++), t[e]
                );
            }),
        g = new ((function () {
            function t() {
            ...
            "top" === c
                ...
                (c =
                    (function (t, e, n, r) {
                        ...
                        return (
                            i - t < e &&
                                (q(r, "top-left-aligned"),
                                q(r, "bottom-left-aligned")),
                            (t < o || i - t < o) &&
                                (q(r, "top-middle-aligned"),
                                q(r, "bottom-middle-aligned")),
                            t < e &&
                                (q(r, "top-right-aligned"),
                        ...
                        switch ((e.prev = e.next)) {
                            ...
                            case 3:
                                if (
                                    ...
                                    "string" ==
                                        typeof n._options.highlightClass &&
                                        (s += " ".concat(
                                            n._options.highlightClass
                                        )),
                                    null !== i && null !== a
                                        ? ((p = a.querySelector(
                                        ...
                                        ? (null != c &&
                                          ...
                                          !0 === n._options.hideNext
                                              ? (null != l &&
                                                ...
                                                null != c &&
                                                    _(c, "introjs-fullbutton"))
                                              : null != l &&
                                                (!0 === n._options.nextToDone
                                                    ? ((l.innerHTML =
                                                          n._options.doneLabel),
                                                      _(
                                                          l,
                                                          "".concat(
                                                              n._options
                                ...
                                return (
                                    (e.next = 21),
                                    n._introAfterChangeCallback.call(
                                        n,
                                        o.element
                                    )
                                );
                            ...
                            switch ((t.prev = t.next)) {
                                case 0:
                                    if (
                                        ...
                                        for (
                                            r = 0;
                                            r < n._introItems.length;
                                            r++
                                        )
                                            n._introItems[r].step ===
                                                n._currentStepNumber &&
                                                ((n._currentStep = r - 1),
                                                (n._currentStepNumber =
                                                    void 0));
                                    if (
                                ...
                                case 9:
                                    ...
                                    return (
                                        --n._currentStep, t.abrupt("return", !1)
                                    );
                                case 12:
                                    if (
                                        !(
                                ...
                                case 16:
                                    return (
                                        (t.next = 18), Nt(n, n._targetElement)
                                    );
                                case 18:
                    ...
                    function (t) {
                        for (;;)
                            switch ((t.prev = t.next)) {
                                ...
                                case 23:
                                    return (
                                        (t.next = 25), kt(n, n._targetElement)
                                    );
                                case 25:
                                case "end":
                                    return t.stop();
                    ...
                    for (;;)
                        switch ((t.prev = t.next)) {
                            ...
                            case 25:
                                ...
                                return (
                                    (t.next = 29), n._hintsAddedCallback.call(n)
                                );
                            case 29:
                                n._options.hintAutoRefreshInterval >= 0 &&
                                    ((n._hintsAutoRefreshFunction = at(
                                        function () {
                                            return Ct(n);
                                        },
        ...
        if (t._options.steps && t._options.steps.length) {
                ...
                for (i.s(); !(o = i.n()).done; ) {
                    ...
                    if (
                        ...
                        "string" == typeof a.element &&
                            (a.element =
                                document.querySelector(a.element) || void 0),
            ...
            try {
                for (u.s(); !(c = u.n()).done; ) {
                    ...
                    if (
                        (!t._options.group ||
                            h.getAttribute("data-intro-group") ===
                                t._options.group) &&
                        ...
                        (l = t._options.disableInteraction),
                            ...
                            f > 0 &&
                                (r[f - 1] = {
                                    ...
                                    tooltipClass:
                                        h.getAttribute("data-tooltip-class") ||
                                        void 0,
                                    highlightClass:
                                        h.getAttribute(
            ...
            try {
                for (v.s(); !(d = v.n()).done; ) {
                    ...
                    if (
                        (!t._options.group ||
                            b.getAttribute("data-intro-group") ===
                                t._options.group) &&
                        ...
                        (l = b.hasAttribute("data-disable-interaction")
                            ...
                            (r[m] = {
                                ...
                                step: m + 1,
                                tooltipClass:
                                    b.getAttribute("data-tooltip-class") ||
                                    void 0,
                                highlightClass:
                                    b.getAttribute("data-highlight-class") ||
                                    void 0,
                                position:
                                    b.getAttribute("data-position") ||
                                    t._options.tooltipPosition,
                                scrollTo:
                                    b.getAttribute("data-scroll-to") ||
                                    t._options.scrollTo,
                                disableInteraction: l,
                            });
                    }
                ...
                e &&
                    ...
                    (function (t, e) {
                        if (t._options.showBullets) {
                            ...
                            n &&
                                n.parentNode &&
                                n.parentNode.replaceChild(V(t, e), n);
                        }
                    })(t, r),
            ...
            return (
                a(e, [
                    ...
                    },
                    {
                        ...
                        value: function (t, e) {
                            return (
                                (this._options = Ot(this._options, t, e)), this
                            );
                        },
                    },
                    {
